...
<body>
  <pre>
    ...
    index.html 과 index.jsp 의 차이

    html : html, css, js 코드작성 가능
          + 정적 페이지(미리 만들어진 형태그대로)

    jsp  : html, css, js, java, el, jstl 작성가능
          + 동적 페이지(요청에따라 응답화면 변함 가능)
  </pre>
  ...
  <h1>
    <a href="/el/scope">Servlet/JSP 범위(Scope)별 내장객체
     + EL 사용법</a>
  </h1>
...
<%-- 중요! 면접때도 많이 물어봄 --%>
  ...
  <pre>
    ...
    - 보통 Servlet 요청 처리 후  
      특정 JSP로 요청을 위임해 
      결과 화면을 응답해 주는 것이 아닌
      (요청받은 Servlet이 응답해줄 JSP가 없음)

    - 다른 Servlet을 다시 요청하여
      다른 Servlet의 결과화면을 응답해줌
